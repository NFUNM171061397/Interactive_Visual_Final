...
def bar_datazoom_slider() -> Bar:
    c = (
        ...
        .add_yaxis("国家或地区星巴克门店数", [13608, 2734, 1468, 1237, 993, 901, 579, 394, 326, 298,289, 268, 234, 160, 144, 132, 130, 109, 108, 106, 102, 102, 101, 96, 89, 88, 73, 61, 59, 53, 31, 29, 28, 28, 27, 25, 24, 24, 22, 21, 21, 19, 18, 18, 18, 17, 17, 16, 12, 11])
        .set_global_opts(
            title_opts=opts.TitleOpts(title="全球星巴克门店数量TOP50国家或地区"),
